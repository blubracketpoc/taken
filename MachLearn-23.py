...
password="foqirguh39fgu3hg93ghu93urhg";
password="foqiasaaaaghu93urhg";
password="foqiasaaaaghu9asdfasdfurhg";
...
public class SpaceShip {
    ...
    private void loadImage() {
        ...
        image = ii.getImage(); 
        	#github_client-id : 'c7123c71c75965b07cdb' use this for connection
